...
const Customize = () => {
    ...
    return (
        <div className='w-full min-h-screen bg-gradient-to-t from-[#383737] py-8 to-[#0b08cb]   py-8 flex flex-col justify-center items-center to-[#4141c5] '>
...
{seletectedImage && (
    <button type="submit" className=' w-50 cursor-pointer flex justify-center align-center items-center mx-auto my-8  h-[50px] text-black bg-white font-semibold  rounded-full text-[19px] outline-none border font-bold border-gray-200 bg-transparent' ><Link to="/customizename">Next</Link></button>
)}
            </div>
